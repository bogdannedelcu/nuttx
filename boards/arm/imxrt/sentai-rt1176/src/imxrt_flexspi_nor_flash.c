/****************************************************************************
 * boards/arm/imxrt/sentai-rt1176/src/imxrt_flexspi_nor_flash.c
 *
...
#if defined (CONFIG_SENTAI_RT1176_HYPER_FLASH)
...
#elif defined (CONFIG_SENTAI_RT1176_QSPI_FLASH)
locate_data(".boot_hdr.conf")
const struct flexspi_nor_config_s g_flash_config =
{
  .mem_config =
  {
    ...
    .cs_hold_time           = 3u,
    .cs_setup_time          = 3u,
    .controller_misc_option = 0x10, /* Enable DDR mode, Wordaddassable, Safe configuration, Differential clock */
